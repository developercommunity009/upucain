...
const TrackingModal = ({ open, setOpen , trackingId , token }) => {
    ...
    const fetchTrackingById = async () => {
        const response = await fetch(`${BACKEND_URL}/api/v1/tracking/${trackingId}`, {
            method: 'GET',
            headers: {
    ...
    const { data = [], error, isFetching } = useQuery({
        queryKey: ['fetchTrackinkById'], // Updated key format
        queryFn: fetchTrackingById,
        onError: (error) => {
...
// createdAt
// : 
// "2024-07-30T09:31:04.429Z"
// dateTime
// : 
// "2024-07-30T09:31:04.428Z"
// seqNo
// : 
// 1
// trackingId
                    ...
                    >
                        ...
                        >
                            ...
                            <div className='px-[20px]'>
                                ...
                                <div className='border-t  border-gray-300  mt-[10px] space-y-[5px] py-[10px]'>
